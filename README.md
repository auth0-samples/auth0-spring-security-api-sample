...
[![CircleCI](https://img.shields.io/circleci/project/github/auth0-samples/auth0-spring-security-api-sample.svg?style=flat-square)](https://circleci.com/gh/auth0-samples/auth0-spring-security-api-sample)
